        ...
        <div className="Login_subParent-container">
          ...
          <div className="overflow-loginin">
            ...
            <div className="pass-word-in2">
              <input className="second-input-pass" type="text" readOnly value={userName} />
            </div>
            <label  className={`password-lable ${passwordBorder && "password-outline"}`}   onClick={PasswordBorderChange} >
            <div className="user-name-in1">
              ...
              <input className="first-input-login" type="password"  onFocus={InputFocusOutline}
                      onBlur={InputBlurOutline}/>
            </div>
            </label>
           
          </div>
        <button className="Login-button" onClick={Navigation}>Log in</button>
